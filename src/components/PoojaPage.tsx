...
const PoojaPage: React.FC<PoojaPageProps> = ({ pujas }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Reserve your place in our divine ceremonies and experience spiritual bliss
          </p>
        </div>
        ...
        {pujas.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-gray-600 mb-4">No Poojas Available</h3>
            <p className="text-gray-500 text-lg">New pooja bookings will be available soon. Stay tuned!</p>
          </div>
        ) : (
